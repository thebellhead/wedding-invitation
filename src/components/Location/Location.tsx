          ...
          <div className="message-container">
            ...
            <div id="speech" className="center">
              <div className="speech-bubble">
                Не волнуйтесь о том, как добраться на наш праздник! Всех гостей
                сразу после венчания будет ожидать автобус в 13:00. И после
                окончания праздника Вас также доставят в город в целости и
                сохранности.
              </div>
            </div>
          </div>
